...
from app.services.review_service import create_product_review, get_average_rating
...
async def post_review(
    ...
    return ApiResponse[ReviewResponse](
        status=status.HTTP_201_CREATED, message="Review Added Successfully", data=review
    )
